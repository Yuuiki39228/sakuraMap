...
function updateStats() {
    ...
    document.getElementById('stat-mall-count').textContent = mallCount;
    document.getElementById('stat-city-count').textContent = cities;
    document.getElementById('stat-screen-count').textContent = totalScreens;
    document.getElementById('list-count').textContent = mallCount + ' 个';

    const now = new Date();
    document.getElementById('sidebar-update-time').textContent = now.toLocaleTimeString('zh-CN', { hour: '2-digit', minute: '2-digit' });
}